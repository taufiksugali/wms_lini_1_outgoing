      ...
      <div class="row g-0 p-0 m-0">
        ...
        <div class = "col-sm-4 px-3" id="formAddFlight">
          <div class="mb-3">
            ...
            <label for="awb" class="form-label mt-3">Flight Number</label>
            ...
            <div class="d-flex justify-content-start">
              ...
              <div class="ms-2">
                <label for="noflight" class="form-label mt-3">IATA Code</label>
              ...
              <tbody>
                ...
                while($s_result=$result->fetch_object()) : 
                  ...
                  <tr>
                    ...
                    <th class="text-center"><?php echo $s_result->airline_id; ?></th>
